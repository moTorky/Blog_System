<footer class="site-footer">
					...
					<div class="widget">
						...
						<div class="post-entry-footer">
							<ul>
								...
								try{
									$sql=$db->prepare('SELECT `id`,`cover_img_path`,`title`,`created` FROM `posts` WHERE `published`=1 ORDER BY created DESC LIMIT 3');
									$sql->execute();
									$TOP_POSTS=$sql->fetchAll(PDO::FETCH_ASSOC);
								}catch(Exception $e){
									$errors['fetch_post']='faild to get newest posts';
								}
    ...
    <script src="assets/user/js/flatpickr.min.js"></script>
